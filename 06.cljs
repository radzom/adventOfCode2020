...
(defn combined-answers-of-group [group] (->> group
                                             (reduce str "")
                                             distinct 
                                             count))

(defn common-answers-of-group [group] (->> group
                                           (map #(str/split %1 ""))
                                           (map set)
                                           (reduce s/intersection)
                                           count))

(defn sum-of-all-groups [fn] (->> groups
                                  (map fn)
                                  (reduce + 0)))


(println (sum-of-all-groups combined-answers-of-group)) ;; 6382
(println (sum-of-all-groups common-answers-of-group)) ;; 3197
